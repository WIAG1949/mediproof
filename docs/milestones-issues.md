# GitHub Issues Backlog — Mediproof

## Batch 1 — Foundation & Scaffolding (Phase 1)

### Issue 1: Initialize `batch-registry` contract scaffold
...
### Issue 2: Define storage data types for `batch-registry`
**Labels:** `contracts` `good first issue` `phase-1`
...
### Issue 3: Implement `batch-registry` core write functions
...
### Issue 4: Implement `batch-registry` query functions
**Labels:** `contracts` `good first issue` `phase-1`
...
### Issue 5: Initialize `coldchain-proof` contract scaffold
**Labels:** `contracts` `good first issue` `phase-1`
Mirror of Issue 1 for the `coldchain-proof` contract.
**Acceptance Criteria:** Compiles, `initialize` called once, version exposed.

---

### Issue 6: Implement `coldchain-proof` pool/management logic
**Labels:** `contracts` `phase-1`
Implement the core pooling or management logic unique to `coldchain-proof`.
**Acceptance Criteria:** Integration test simulates full lifecycle, edge cases covered.

---

### Issue 7: Initialize `recall-manager` contract scaffold
**Labels:** `contracts` `good first issue` `phase-1`
Scaffold the `recall-manager` contract with required entrypoints.
**Acceptance Criteria:** Compiles, unit tested.

---

### Issue 8: Implement `recall-manager` execution logic
**Labels:** `contracts` `phase-1`
