# Contributing to Mediproof

Thank you for contributing to Mediproof! This guide will help you get started.
...
```bash
git clone https://github.com/grantfox-org/mediproof.git
cd mediproof
pnpm install
pnpm dev
```
...
fix: resolve storage collision in mediproof
...
Open a [Discussion](https://github.com/grantfox-org/mediproof/discussions) on GitHub.
