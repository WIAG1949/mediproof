export const metadata = {
  title: "Recalls",
  description: "Mediproof Recalls — explore the recalls section.",
};
  ...
  return (
    <main className="min-h-screen bg-[#0a0a0f] text-white pt-24 px-6">
      <div className="max-w-5xl mx-auto">
        <div className="mb-8">
          <span className="text-xs font-mono text-white/40 uppercase tracking-widest">/recalls</span>
          <h1 className="text-4xl md:text-5xl font-bold mt-2 mb-4">Recalls</h1>
