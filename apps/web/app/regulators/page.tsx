export const metadata = {
  title: "Regulators",
  description: "Mediproof Regulators — explore the regulators section.",
};
  ...
  return (
    <main className="min-h-screen bg-[#0a0a0f] text-white pt-24 px-6">
      <div className="max-w-5xl mx-auto">
        <div className="mb-8">
          <span className="text-xs font-mono text-white/40 uppercase tracking-widest">/regulators</span>
          <h1 className="text-4xl md:text-5xl font-bold mt-2 mb-4">Regulators</h1>
